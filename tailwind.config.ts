  ...
  theme: {
    ...
    extend: {
      ...
      keyframes: {
        ...
        "glow-pulse":{ "0%,100%": { boxShadow: "0 0 20px hsl(184 100% 50% / 0.4)" }, "50%": { boxShadow: "0 0 50px hsl(184 100% 50% / 0.7)" } },
        "scroll-down": { "0%": { transform: "translateY(0)", opacity: "0" }, "30%": { opacity: "1" }, "100%": { transform: "translateY(14px)", opacity: "0" } },
